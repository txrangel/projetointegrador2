                ...
                <section>
                    ...
                    <form method="post" action="{{ route('plantas.store') }}" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="maximo_carretas" name="maximo_carretas" type="number" class="mt-1 block w-full" :value="old('maximo_carretas')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="maximo_entregas" name="maximo_entregas" type="number" class="mt-1 block w-full" :value="old('maximo_entregas')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="qtd_entrega_padrao" name="qtd_entrega_padrao" type="number" class="mt-1 block w-full" :value="old('qtd_entrega_padrao')" required />
